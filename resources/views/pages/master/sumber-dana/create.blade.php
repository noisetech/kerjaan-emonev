...
@section('content')
    ...
    <div class="container-fluid mt-3">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Form tambah sumber dana</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="card shadow mt-1">
            ...
            <div class="card-body">
                <form action="#" id="form_tambah_sumber_dana" method="POST">
                    @csrf
...
@push('script')
    <script>
        $("#form_tambah_sumber_dana").submit(function(e) {
            e.preventDefault();
            const fd = new FormData(this);
            $.ajax({
                url: '{{ route('sumber_dana.simpan') }}',
                method: 'post',
                data: fd,
                cache: false,
                processData: false,
