...
@section('content')
                ...
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <p class="font-weight-bold">List Kegiatan</p>

                            <a href="javascript:void(0)" class="badge bg-primary text-white" onclick="tambahKegiatan()">
                                Tambah
                            </a>
                        </div>
                    </div>
    ...
    {{-- modal tambah urusan --}}
    <div class="modal fade" id="modal_tambah_kegiatan" tabindex="-1" aria-labelledby="scrollableModalTitle"
        style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="scrollableModalTitle">Form Tambah Keigatan</h5>
                    <button type="button" class="btn-close" onclick="closeAtasTambahKegiatan)"></button>
                </div>
                <div class="modal-body">
                    <form action="#" id="form_tambah_kegiatan" method="POST">
                        @csrf

                        <input type="hidden" name="program_id" class="form-control" value="{{ $program_id }}">
    ...
    {{-- modal edit urusan --}}
    <div class="modal fade" id="modal_edit_kegiatan" tabindex="-1" aria-labelledby="scrollableModalTitle"
        style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="#" id="form_edit_kegiatan" method="POST">
                        ...
                        <input type="hidden" name="program_id" class="program_id_edit">
                        ...
                        <div class="d-flex justify-content-end align-items-center mt-2">
                            ...
                            <button type="submit" class="btn badge bg-primary text-white"
                                id="btn-edit-kegiatan">Simpan</button>
                        </div>
                    </form>
                </div>
...
@push('script')
    <script>
            ...
            $('#datatable').DataTable({
                ...
                columns: [{
                        ...
                        render: function(data, type, row) {
                            return '<a href="/dashboard/perencanaan/sub_kegiatan/' +
                                row.id +
                                '" >' + data +
                                '</a>';
                        }
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'success') {
                        ...
                        $("#btn-simpan-kegiatan").text('Simpan');
        ...
        function editKegiatan(data, idBahanEditKegiatan) {
            $('#modal_edit_kegiatan').modal('show');

            $.ajax({
                url: '{{ route('kegiatanById') }}',
                method: 'get',
                data: {
                ...
                success: function(response) {
                    ...
                    $('.program_id_edit').val(response.program_id);
        ...
        function hapusKegiatan(data, idBahanHapusKegiatan) {
            Swal.fire({
