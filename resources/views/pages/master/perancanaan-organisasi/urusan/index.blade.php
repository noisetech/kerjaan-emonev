    ...
    <script>
        $(document).ready(function() {
            $('#datatable').DataTable({
                ...
                order: [],
                ajax: {
                    url: "{{ route('perencanaan_organisasi.urusan-data') }}",
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        ...
                        render: function(data, type, row) {
                            return '<a href="/dashboard/perencanaan-organisasi/bidang/' +
                                row.id +
                                '" >' + data +
                                '</a>';
                        }
        ...
        function editUrusan(data, idBahanEditUrusan) {
            ...
            $.ajax({
                url: '{{ route('perencanaan-organisasi.urusanById') }}',
                method: 'get',
                data: {
        ...
        $("#form_edit_urusan").submit(function(e) {
            ...
            const fd = new FormData(this);
            $.ajax({
                url: '{{ route('perencanaan-organisasi.urusan-update') }}',
                method: 'post',
                data: fd,
                cache: false,
                processData: false,
        ...
        function hapusUrusan(data, idBahanHapusUrusan) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('perencanaan-organisasi.urusan-hapus') }}",
                        data: {
